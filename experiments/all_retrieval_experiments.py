...
def build_experiments(skip_training: bool = False):
    cmds = [
...
def parse_args():
    ...
    parser.add_argument(
        "--skip-training",
        action="store_true",
        help="Skip model training scripts (autoencoder, CNN, contrastive)",
    )
    parser.add_argument(
        "--logs-dir",
        type=Path,
...
def main():
    ...
    experiments = build_experiments(skip_training=args.skip_training)
